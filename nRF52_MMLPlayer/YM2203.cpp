...
inline static void set_data(uint8_t v)
{
  digitalWrite(IO_YMF_DATA_0, ((v & 0x01) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_1, ((v & 0x02) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_2, ((v & 0x04) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_3, ((v & 0x08) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_4, ((v & 0x10) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_5, ((v & 0x20) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_6, ((v & 0x40) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_DATA_7, ((v & 0x80) == 0) ? LOW : HIGH);
}

inline static void set_addr(uint8_t v)
{
  digitalWrite(IO_YMF_ADDR_0, ((v & 0x01) == 0) ? LOW : HIGH);
  digitalWrite(IO_YMF_ADDR_1, ((v & 0x02) == 0) ? LOW : HIGH);
}
...
#else
	set_addr(0);
	digitalWrite(IO_YMF_WR, LOW);
	digitalWrite(IO_YMF_CS, LOW);
	set_data(addr);
	delayMicroseconds(2);
