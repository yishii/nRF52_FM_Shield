...
void setup()
{
	...
	pinMode(IO_YMF_RD, OUTPUT);
	pinMode(IO_YMF_WR, OUTPUT);
	pinMode(IO_YMF_CS, OUTPUT);
	pinMode(IO_YMF_ADDR_0, OUTPUT);
	pinMode(IO_YMF_ADDR_1, OUTPUT);
	pinMode(IO_YMF_DATA_0, OUTPUT);
	pinMode(IO_YMF_DATA_1, OUTPUT);
	pinMode(IO_YMF_DATA_2, OUTPUT);
	pinMode(IO_YMF_DATA_3, OUTPUT);
	pinMode(IO_YMF_DATA_4, OUTPUT);
	pinMode(IO_YMF_DATA_5, OUTPUT);
	pinMode(IO_YMF_DATA_6, OUTPUT);
	pinMode(IO_YMF_DATA_7, OUTPUT);
	pinMode(IO_YMF_RESET, OUTPUT);

	digitalWrite(IO_YMF_RD, HIGH);
	digitalWrite(IO_YMF_WR, HIGH);
	digitalWrite(IO_YMF_CS, HIGH);
	digitalWrite(IO_YMF_ADDR_0, HIGH);
	digitalWrite(IO_YMF_ADDR_1, HIGH);
	digitalWrite(IO_YMF_DATA_0, HIGH);
	digitalWrite(IO_YMF_DATA_1, HIGH);
	digitalWrite(IO_YMF_DATA_2, HIGH);
	digitalWrite(IO_YMF_DATA_3, HIGH);
	digitalWrite(IO_YMF_DATA_4, HIGH);
	digitalWrite(IO_YMF_DATA_5, HIGH);
	digitalWrite(IO_YMF_DATA_6, HIGH);
	digitalWrite(IO_YMF_DATA_7, HIGH);
	digitalWrite(IO_YMF_RESET, HIGH);
	
	pinMode(IO_LED_1, OUTPUT);
	pinMode(IO_LED_2, OUTPUT);
	pinMode(IO_LED_3, OUTPUT);
	pinMode(IO_LED_4, OUTPUT);
